		...
		<div class="form-group">
			<div class="input-group">
				...
				<select id="class" class="form-control">
					...
					<?php
					$list_class = mysqli_query($Admin->Connect, "SELECT `class` FROM `class`");
					while($list = mysqli_fetch_assoc($list_class)){
						if ($list['class'] == $row['class']) {
							continue;
						}

						?>

						<option value="<?php echo $list["class"];?>">
							<?php echo $list["class"]; ?>
						</option>
